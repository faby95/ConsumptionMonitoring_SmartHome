...
public class WaterDevice extends WaterMonitoringResource{
    //Variabili della classe
    private Boolean switchButton;  //Variabile comportamentale di simulazione
    private String location;

    //Costruttori
    public WaterDevice(String deviceName, String location ,Boolean switchButton ) {
    ...
    public WaterDevice(String id, String deviceName, String location, Boolean isOn, Boolean switchButton) {
