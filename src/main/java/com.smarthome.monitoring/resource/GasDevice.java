...
public class GasDevice extends GasMonitoringResource{
    //Variabili della classe
    private Boolean switchButton;  //Variabile comportamentale di simulazione
    private String location;

    //Costruttori
    public GasDevice(String deviceName, String location ,Boolean switchButton ) {
    ...
    public GasDevice(String id, String deviceName, String location, Boolean isOn, Boolean switchButton) {
